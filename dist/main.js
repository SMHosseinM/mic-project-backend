...
const routes_3 = __importDefault(require("./src/app/services/dashboard/member/routes"));
const routes_4 = __importDefault(require("./src/app/services/authentication/routes"));
...
app.use('/dashboard/member', routes_3.default);
